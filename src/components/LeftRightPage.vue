<template>
  <div class="left-right-page">
    <page-card class="left-right-page-card" :scrollable="false">
      <slot name="header"></slot>

      <div class="page-content-container">

        <div class="search-data-container" v-if="leftShow" :style=" rightFixed ? {width: `calc(100% - ${rightWidth})`} : {'width': leftWidth, 'min-width': leftMinWidth}">
          <slot name="leftData">
          </slot>
        </div>
